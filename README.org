...
- Send a [[mailto:~bzg/orgology@lists.sr.ht?subject=\[BUG\] orgy: <SHORT EXPLICIT BUG DESCRIPTION>][bug report]]
- Send a [[mailto:~bzg/orgology@lists.sr.ht?subject=\[PATCH\] orgy: <COMMIT SUMMARY>][patch]] (please use =git format-patch=)
- Send a [[mailto:~bzg/orgology@lists.sr.ht?subject=\[FR\] orgy: <FEATURE REQUEST>][feature request]]
- Share any [[mailto:~bzg/orgology@lists.sr.ht?subject=orgy: <ANYTHING>][other question or idea]]
